...
const contractAddress = "0x1d991274d9a2faaf5e7298b9494195c2f91bde30" // 合约地址
  	...
  	render() {
		return (
			<div className="container">
				<header className="header">永不消逝的留言</header>
				<main>
				...
				<footer>By <a href="https://www.ldsun.com" target="_blank">阿欣</a></footer>
